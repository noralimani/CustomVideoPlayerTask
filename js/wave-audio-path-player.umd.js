...
var ot = (v, m, A) =>
  m in v
    ? ht(v, m, { enumerable: !0, configurable: !0, writable: !0, value: A })
    : (v[m] = A);
...
(function (v, m) {
  ...
  const m = (g) => {
    ...
    A = (T, J) => {
      ...
      const {
        ...
        left: a = 0,
        type: s = "steps",
        paths: t = [{ d: "Q", sx: 0, sy: 0, x: 50, y: 100, ex: 100, ey: 0 }],
        animation: k = !1,
        animationframes: L = 10,
        normalize: F = !0,
      } = J;
      var J = tt(T, h, k, L),
        T = et(J, u),
      ...
      for (let S = 0; S < st; S++) {
        ...
        for (let o = 0; o < u; o++) {
          ...
          for (let z = 0; z < at; z++) {
            let e = z;
            z >= N && ((e = z - N), (b = -1)),
              (t[e].minshow = (W = t[e].minshow) != null ? W : 0),
              (t[e].maxshow = (X = t[e].maxshow) != null ? X : 1),
              (t[e].normalize = (Y = t[e].normalize) != null ? Y : !1);
            var x = t[e].normalize ? 1 : H[S][o];
            if (t[e].minshow <= H[S][o] && t[e].maxshow >= H[S][o])
              switch (t[e].d) {
                case "L":
                  var D = o * r + (r * t[e].sx) / 100 + a,
                    C =
                      p +
                      ((x * t[e].sy) / 100) *
                        (s != "bars" ? i / 2 : i) *
                ...
                case "V":
                  ...
                  break;
                case "C":
                  var I = o * r + (r * t[e].sx) / 100 + a,
                    M = p - ((p * t[e].sy) / 100) * c,
                    j = o * r + (r * t[e].x) / 100 + a,
                    q =
                      p +
                      ((x * t[e].y) / 100) * (s != "bars" ? i : 2 * i) * -c * b,
                    Q = o * r + (r * t[e].ex) / 100 + a,
                    _ = p - ((p * t[e].ey) / 100) * c;
                  (I === y && M === f) || (l += `M ${I} ${M} `),
                    (l += `C ${I} ${M} ${j} ${q} ${Q} ${_} `),
                    (y = Q),
                ...
                case "A": {
                  ...
                  c == -1 && (V = V == 1 ? 0 : 1),
                    b == -1 && (V = V == 1 ? 0 : 1),
                    (l += `A ${rt} ${nt} ${t[e].angle} ${t[e].arc} ${V} ${K} ${U} `),
                    (y = K),
                    (f = U);
                  break;
                }
  ...
  class Z extends HTMLElement {
    constructor() {
      super();
      $(this, "loadSong", () => {
        (this.durationContainer.textContent = this.calculateTime(
          this.audio.duration
        )),
          ...
          this.animation ||
            this.animationsvgx.setAttribute(
              "dur",
              "" + this.audio.duration + "s"
            ),
      ...
      $(this, "sliderInput", () => {
        (this.path2.style.display = "block"),
          (this.currentTimeContainer.textContent = this.calculateTime(
            this.seekSlider.value
          )),
          this.svg.setCurrentTime(this.seekSlider.value),
          this.audio.paused || cancelAnimationFrame(this.raf);
      });
      $(this, "sliderChange", () => {
      ...
      $(this, "svgDraw", () => {
        const n = A(this.audioData, this.options);
        this.animation
          ? this.animationsvg.setAttribute("values", n)
          : (this.path1.setAttribute("d", n), this.path2.setAttribute("d", n)),
          this.svg.setCurrentTime(this.seekSlider.value);
      });
      ...
      (this.shadowDOM = this.attachShadow({ mode: "open" })),
        (this.audioData = null),
        this.hasAttribute("wave-options")
          ? ((this.options = JSON.parse(this.attributes["wave-options"].value)),
            (this.options.width = parseInt(
              this.attributes["wave-width"].value
            )),
            (this.options.height = parseInt(
              this.attributes["wave-height"].value
            )))
          : (this.options = {
              samples: 40,
              type: "mirror",
        ...
        this.options.hasOwnProperty("animation")
    ...
    initComponent() {
      (this.playPathButton = this.shadowDOM.getElementById("playPathButton")),
        ...
        (this.currentTimeContainer =
          this.shadowDOM.getElementById("current-time")),
        ...
        this.animation
          ...
          : (n += `
            <defs>
                ...
                <rect x="-1" y="-100" width="${
                  parseInt(this.attributes["wave-width"].value) + 2
                }" height="${
              parseInt(this.attributes["wave-height"].value) + 200
            }" >
                    <animate id="animationsvgx" attributeName="x" values="-1;${
                      parseInt(this.attributes["wave-width"].value) + 2
                    }" dur="99999s" fill="freeze" />   
                </rect>
                </clipPath>
              ...
              parseInt(this.attributes["wave-height"].value) + 200
                    ...
                    <animate id="animationsvg" attributeName="x" values="-${
                      parseInt(this.attributes["wave-width"].value) + 2
                    };-1" dur="99999s" fill="freeze" />   
                </rect>
                </clipPath>    
            </defs> 
      ...
      return `
            ...
            *, :after, :before { 
            ...
            #play svg {
                fill: ${
                  (h =
                    (n = this.attributes.color) == null ? void 0 : n.value) !=
                  null
                    ? h
                    : "#858a8d"
                };
            ...
            #path1 {
                stroke: ${
                  (i =
                    (u = this.attributes["wave-color"]) == null
                      ? void 0
                      : u.value) != null
                    ? i
                    : "#dadcdd"
            ...
            #path2 {
                stroke: ${
                  (d =
                    (w = this.attributes["wave-progress-color"]) == null
                      ? void 0
                      : w.value) != null
                    ? d
                    : "#ffffff"
            ...
            #duration, #current-time {
                ...
                color: ${
                  (s =
                    (a = this.attributes.color) == null ? void 0 : a.value) !=
                  null
                    ? s
                    : "#858a8d"
                };
            ...
            input[type=range]::-webkit-slider-thumb {
                ...
                background:  ${
                  (k =
                    (t = this.attributes["wave-slider"]) == null
                      ? void 0
                      : t.value) != null
                    ? k
                    : "#4fc3f7"
            ...
            input[type="range"]::-moz-range-thumb {
                ...
                background:  ${
                  (F =
                    (L = this.attributes["wave-slider"]) == null
                      ? void 0
                      : L.value) != null
                    ? F
                    : "#4fc3f7"
  ...
  window.customElements.define("wave-audio-path-player", Z),
    (v.AudioPathPlayer = Z),
